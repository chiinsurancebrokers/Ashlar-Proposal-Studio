...
def _labels(language: str) -> dict:
    ...
    if greek:
        return {
            ...
            "assessment": "ΠΡΟΤΑΣΗ ASHLAR", "preferred": "Προτεινόμενη επιλογή", "alternative": "Ισχυρή εναλλακτική",
            "extras": "Επιλογή με ευρύτερα πρόσθετα", "budget": "Οικονομικότερη επιλογή",
    ...
    return {
        ...
        "assessment": "ASHLAR RECOMMENDATION", "preferred": "Recommended option", "alternative": "Strong alternative",
        "extras": "Broader extras option", "budget": "Budget option",
...
def build_pptx_bytes(*, client_analysis: dict, results: list[dict], language: str = "English") -> bytes:
    ...
    # Assessment / recommendation — clear broker direction plus practical alternatives.
