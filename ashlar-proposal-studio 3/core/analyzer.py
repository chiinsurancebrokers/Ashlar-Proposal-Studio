...
"""
    ...
    try:
        ...
        # Never take down the whole case workspace because a model added prose,
        # truncated JSON, or otherwise returned malformed structured output.
        # Keep a small diagnostic excerpt for the broker/admin instead.
        return {
            "provider": provider_label,
            "plan_name": target_plan or None,
            "target_plan_found": bool(focused_table_context),
    ...
    # Ensure the few fields the UI relies on always exist even if the model
    # omitted an optional key.
