...
7. Do not provide a final placement decision as if you were the insurer. Underwriting and final acceptance remain subject to carrier confirmation.
8. Keep answers concise unless the broker asks for a detailed analysis.
"""
...
def build_case_context(case_reference: str, results: list[dict]) -> str:
    payload = {
...
def ask_case_agent(
    *,
    ...
    case_context = build_case_context(case_reference, results)
